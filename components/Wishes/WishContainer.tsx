  ...
  return (
    ...
    <div className="w-full h-auto flex items-center justify-between m-2 mt-3 ml-0 p-1 pt-0 pb-0">
        ...
        <Link href={`/home/${params.uid}/wishes/${params.id}/createWish`}>
          <button className='sm:w-32 w-7 h-7 text-black bg-yellow text-sm bg-button rounded-md flex items-center justify-center'>+ <span className='sm:flex hidden pl-2'>New wish</span> </button>
        </Link>
