...
const SideBar = () => {
  ...
  return (
    ...
    <div data-aos="fade-right"  data-aos-delay="50"   className='w-sidebar min-h-screen  bg-yellow-100 sm:flex hidden flex-col justify-between p-8 pt-7  '>
        ...
        <p className='text-md text-black pt-2'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perspiciatis quibusdam eveniet numquam, aspernatur recusandae eius harum ullam velit laudantium assumenda.</p>
