    ...
    <div className='w-full h-auto '>
        <div className='w-full h-auto '>
            ...
            <div className='w-11/12 h-8  flex items-center pl-3'>
                ...
                <p className='text-sm font-medium pl-2 pt-1'>History   </p>
            </div>
...
<p className='text-sm font-medium pl-2 pt-1'>Our aim</p>
</div>
...
<div className='w-11/12 h-auto  flex items-center pl-3'>
<p className='text-xl'>💪</p>
<p className='text-sm font-medium pl-2 pt-1'>What's about future ?</p>
</div>
